...
from pilot_core.context import (
    build_context,
    load_agent_config,
    get_current_branch,
)
...
from pilot_core.log import log_agent
from pilot_core.run import Run
from pilot_tools.context import context as gather_context
from pilot_core.search import get_all_rules
from pilot_core.violation_watcher import start_watcher
from pilot_core.repo_search import context_for as repo_search_context
...
async def invoke_agent(
    ...
    if success:
        ...
        try:
            from pilot_core.attribution import track_agent_files
        ...
        if agent_name == "git-reviewer" and "APPROVED" in output_text:
            try:
                from pilot_core.approve import record_reviewer_session
